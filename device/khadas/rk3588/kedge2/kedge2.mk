...
PRODUCT_BRAND := oppo
PRODUCT_MODEL := DynamicCluster
PRODUCT_MANUFACTURER := DashTech
...
PRODUCT_PROPERTY_OVERRIDES += persist.ui_night_mode=2
PRODUCT_PROPERTY_OVERRIDES += persist.sysui.monet=true
...
PRODUCT_PROPERTY_OVERRIDES += ro.sf.blurs_are_expensive=1
PRODUCT_PROPERTY_OVERRIDES += ro.surface_flinger.supports_background_blur=1
PRODUCT_PROPERTY_OVERRIDES += persist.sys.sf.disable_blurs=0
PRODUCT_PROPERTY_OVERRIDES += persist.sysui.disableBlur=false
PRODUCT_PROPERTY_OVERRIDES += ro.config.avoid_gfx_accel=false
