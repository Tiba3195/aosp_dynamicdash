...
# Call the script
$(shell cp -r customdata/keyborads/* frameworks/base/data/keyboards/ && chmod 644 frameworks/base/data/keyboards/*)
$(shell mkdir -p vendor/rockchip/common/apps/KSettings/src/jni/includes)
$(shell cp device/khadas/rk3588/gpio_control/gpiocontrol.h vendor/rockchip/common/apps/KSettings/src/jni/includes/gpiocontrol.h)

PRODUCT_COPY_FILES += \
    out/target/product/kedge2/obj/SHARED_LIBRARIES/libjni_ksettings_intermediates/LINKED/libjni_ksettings.so:system/lib64/libjni_ksettings.so

PRODUCT_COPY_FILES += \
    out/target/product/kedge2/obj/SHARED_LIBRARIES/libjni_ksettings_intermediates/LINKED/libjni_ksettings.so:vendor/system/lib64/libjni_ksettings.so
